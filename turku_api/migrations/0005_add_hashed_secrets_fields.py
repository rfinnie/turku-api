...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Machine.secret_hash'
        db.add_column(u'turku_api_machine', 'secret_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Storage.secret_hash'
        db.add_column(u'turku_api_storage', 'secret_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Machine.secret_hash'
        db.delete_column(u'turku_api_machine', 'secret_hash')

        # Deleting field 'Storage.secret_hash'
        db.delete_column(u'turku_api_storage', 'secret_hash')
    ...
    models = {
        u'turku_api.auth': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'193cbce9-28c8-4376-8651-c7969cbe7aba'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        u'turku_api.machine': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'2ec4e8d2-3be8-405c-95a1-eefe43bc4f37'", 'max_length': '36', 'primary_key': 'True'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        u'turku_api.source': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'3189bd35-82fc-4770-adfa-c19cfdff9781'", 'max_length': '36', 'primary_key': 'True'}),
        ...
        u'turku_api.storage': {
            ...
            'date_registered': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.CharField', [], {'default': "'e3a71b73-bfc7-44b3-971a-3c7f43d16729'", 'max_length': '36', 'primary_key': 'True'}),
